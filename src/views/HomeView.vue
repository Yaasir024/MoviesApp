  ...
  <div class="home">
    <div class="feature-card">
      <router-link to="/moviedetail/tt0988824">
        <img class="featured-img" src="../assets/narutoship.jpg" alt="Naruto: Shippûden">
        <div class="detail">
    ...
    <main>
        <div class="search-bar">
          <p>SEARCH</p>
          <form @submit.stop="searchMovie()" class="search-box">
        ...
        <div class="movies-list">
          <div class="movie" v-for="movie in movies" :key="movie.imdbID">
            <router-link :to="'/moviedetail/' + movie.imdbID" class="movie-container">
              <div class="cover-img">
...
export default {
  ...
  methods: {
    searchMovie() {
      this.loading = true
      if (this.searchInput != "") {
        fetch(`https://www.omdbapi.com/?apikey=${key.apiKey}&s=${this.searchInput}`)
        .then(res => res.json())
        .then(data => {
